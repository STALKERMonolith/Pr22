...
const REQUIRED_APPLES = 10;  // Кількість яблук, яку потрібно зібрати для перемоги
...
const texts1 = [ // неправильні варіанти
    "Показує дерево директорій у графічному вигляді.", //
    "Видаляє текстові файли з каталогу.", //
    "Виводить список лише прихованих файлів.", //
    "Перезапускає термінал користувача.", //
    "Створює каталог з довільним вмістом.", //
    "Видаляє каталоги, але не може працювати з файлами.", //
    "Копіює файл, але видаляє оригінал.", //
    "Переміщує файли тільки між різними дисками.", //
    "Команда для створення резервної копії системи.", //
    "Видаляє всю історію користувача."
];

const texts2 = [ // правильні відповіді
    "Виводить поточний робочий каталог (pwd).", //
    "Відображає текст або змінну в терміналі (echo).", //
    "Показує список файлів і каталогів (ls).", //
    "Переміщення між каталогами (cd).", //
    "Створює порожній файл (touch).", //
    "Створює новий каталог (mkdir).", //
    "Копіює файли або каталоги (cp).", //
    "Переміщує або перейменовує файли/каталоги (mv).", //
    "Видаляє файли або каталоги (rm).", //
    "Показує історію введених команд (history)."
];

const texts3 = [ // питання
    "Яке призначення команди pwd у Linux?", //
    "Що робить команда echo?", //
    "Для чого використовується команда ls?", //
    "Яка команда дозволяє перейти до іншого каталогу?", //
    "Яка команда створює порожній файл?", //
    "Як створити новий каталог у Linux?", //
    "Яка команда використовується для копіювання файлів?", //
    "Яка команда використовується для переміщення або перейменування файлів?", //
    "Яка команда використовується для видалення файлів або каталогів?", //
    "Яка команда показує історію введених у терміналі команд?"
];
