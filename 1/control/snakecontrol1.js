...
const texts1 = [
    "Система для створення резервних копій лише текстових документів.", //
    "Тому що Git працює тільки в онлайн-режимі.", //
    "Білл Гейтс.", //
    "Git зберігає лише список змін у вигляді патчів.", //
    "Тимчасова копія файлів на локальному комп’ютері.", //
    "Усі дані безповоротно втратяться.", //
    "default.", //
    "Ні, без сервера історія недоступна.", //
    "Видалення всіх змін в обраній гілці.", //
    "FTP або SMTP."
];

const texts2 = [ // Правильні відповіді
    "Система, що зберігає зміни у файлах і дозволяє повертатися до попередніх версій.", //
    "Тому що Git зберігає знімки репозиторіїв, а не лише списки змін.", //
    "Лінус Торвальдс.", //
    "Git зберігає інформацію у вигляді знімків (snapshots).", //
    "Збережений знімок стану файлів у репозиторії.", //
    "Код можна відновити з локальної копії іншого розробника.", //
    "master (або main).", //
    "Так, бо у кожного розробника є повна копія репозиторію.", //
    "Додавання змін із однієї гілки в іншу.", //
    "SSH або HTTP."
];

const texts3 = [
    "Що таке система контролю версій?", //
    "Чому Git вважається швидким у порівнянні з іншими СКВ?", //
    "Хто створив Git?", //
    "Яка основна відмінність Git від CVS чи Subversion?", //
    "Що таке комміт у Git?", //
    "Що станеться, якщо сервер з віддаленим репозиторієм Git вийде з ладу?", //
    "Як зазвичай називається основна гілка в Git?", //
    "Чи можна працювати з повною історією проєкту у Git без доступу до сервера?", //
    "Що означає об’єднання гілок у Git?", //
    "Які протоколи використовують для обміну змінами з віддаленим репозиторієм?"
];
